...
import org.apache.qpid.proton.codec.impl.DataFactoryImpl;
...
public final class Proton
{
    ...
    private static final MessengerFactory MESSENGER_FACTORY = new MessengerFactoryImpl();
            //(new ProtonFactoryLoader<MessengerFactory>(MessengerFactory.class)).loadFactory();
    private static final DriverFactory DRIVER_FACTORY = new DriverFactoryImpl();
    ...
    private static final DataFactory DATA_FACTORY = new DataFactoryImpl();
           // (new ProtonFactoryLoader<DataFactory>(DataFactory.class)).loadFactory();
    private static final EngineFactory ENGINE_FACTORY = new EngineFactoryImpl();
    ...
    {
        return new DriverImpl();//return DRIVER_FACTORY.createDriver();
    }
    ...
    {
        return new MessageImpl();// getMessageFactory(implementation).createMessage();
    }
    ...
    {
        return new DriverImpl();//return getDriverFactory(implementation).createDriver();
    }
